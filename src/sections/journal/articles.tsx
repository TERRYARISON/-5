/**
 * Shared article data for the Journal page (journal.md §2–§4).
 * Index `01` is the featured essay; `04` intentionally has no image and
 * renders a placeholder tile per the site's no-photo rule.
 */
