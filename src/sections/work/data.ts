/**
 * Work page data (work.md §3). Every entry maps to one clickable card in the
 * grouped grid and one lightbox slide. `images: []` means the card renders
 * the CSS <PlaceholderCard /> per the user's placeholder request.
 */
